...
func buildSchema() schemaDoc {
	...
	return schemaDoc{
		...
		Properties: map[string]property{
			...
			"action":    {Type: "string", Description: "opaque effect name a consumer (e.g. drover) fires when an agentic task is released; never a command. Meaningful only when agentic is true"},
		...
		Tokens: []tokenSpec{
			...
			{Token: "action:<name>", Field: "action", Desc: "opaque effect name fired on release; bare action: clears"},
